var dominantScreenIDs = ["registerHolder", "loginHolder", "createPostHolder", "postInfoHolder"]
...
function toggleMenu(target){
    ...
    let foundForm = document.getElementById(target).querySelector("form");
    if(foundForm != null){
        foundForm.reset();
        let foundPicPreview = foundForm.querySelector("#previewPic")
